...
class CameraController{
	constructor(gl,camera){
		...
		window.addEventListener("keydown", function(e){ oThis.onKeyDown(e); });	//Handles zoom/forward movement
	}
    ...
    onKeyDown(e){
        //console.lo g(e.keyCode);
        switch(e.keyCode){
            case 38: //up arrow
                console.log('up');
                this.camera.panY( 10 * (this.panRate / this.canvas.height) );
                break;
            case 87: //w
                console.log('w');
                this.camera.panZ(-0.1*(this.zoomRate / this.canvas.height));
                break;
            case 40: //down arrow
                console.log('down');
                this.camera.panY( -10 * (this.panRate / this.canvas.height) );
            ...
            case 65: //a
                console.log('left');
                this.camera.panX( -10 * (this.panRate / this.canvas.height) );
                break;
            case 39: //right arrow
            case 68: //d
                console.log('right');
